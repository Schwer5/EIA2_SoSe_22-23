        ...
        public update(): void {
            ...
            switch (this.activity) {
                ...
                case Activity.CLIMB:
                    ...
                    break;
                case Activity.FLY:
                    this.velocity = new Vector(10 + windStrength_X, 4);
                    break;
            }
            ...
            if ((this.activity == Activity.FLY) && updateParaglider){
                this.position.x = paragliderPosition_X + 10 * (Math.random() - 0.5);
                this.position.y = paragliderPosition_Y + 10 * (Math.random() - 0.5);
            }
