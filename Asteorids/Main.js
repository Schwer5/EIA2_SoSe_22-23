...
(function (L09_Asteroids) {
    ...
    function handleLoad(_event) {
        ...
        L09_Asteroids.crc2.fillStyle = "black"; //Füllung Schwarz
        L09_Asteroids.crc2.strokeStyle = "white"; //Linien weiß
        L09_Asteroids.crc2.fillRect(0, 0, L09_Asteroids.crc2.canvas.width, L09_Asteroids.crc2.canvas.width);
        L09_Asteroids.createPaths(); //funktion createPaths wird aufgerufen welche in Paths.ts ist
