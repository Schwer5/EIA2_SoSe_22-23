namespace L09_Asteroids {
    ...
    export let crc2: CanvasRenderingContext2D; //man merkt sich den CanvasRenderingContext in crc2
    ...
    function handleLoad(_event: Event): void {
        ...
        crc2.fillStyle = "black"; //Füllung Schwarz
        crc2.strokeStyle = "white";//Linien weiß
        crc2.fillRect(0,0,crc2.canvas.width, crc2.canvas.width);

        createPaths(); //funktion createPaths wird aufgerufen welche in Paths.ts ist
